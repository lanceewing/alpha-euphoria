        ...
        return new Promise(function(resolve, reject){
            try{
                ...
                var fn = function(){
                    ...
                    // While there is still more of the song to play.
                    while (player.update()){
                        if (aborted) return;
                        ...
                        var durationInSeconds = player.refresh();

                        // 
                        var n = 4 * ((sampleRate * durationInSeconds) | 0);
                        ...
                        // If we've been running for over 1 second then trigger another call of play function (fn)
